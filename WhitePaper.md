...
It is DAO-governed and utilizes auth-levels to
guarantee a fair and secure governance infrastructure. 
...
the revenue stream. The length of the cycles are governable in a range of 6 to 18 months. There will be monthly votes on 
the length of the cycle that can lengthen or shorten the cycle by a month or simply stay as it is.
...
rather on biometric data which will be stored 
without any trace to the users private data.
