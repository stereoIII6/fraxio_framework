...
class RoadMap extends Component {
    ...
    render() {
        return (<div style={{}} >
            ...
            <div className="row">
            <div className="col-3" style={{ float: "left", height: "100%", marginTop: 0}}>
                <ListGroup>
                    <ListGroupItem style={{background:"none"}}><h4>Fractio Documentation</h4></ListGroupItem>
                    <ListGroupItem id="welcome" onClick={this.onLink}>Welcome</ListGroupItem>
                    <ListGroupItem id="edutainment"  onClick={this.onLink}>Fractio Edutainment</ListGroupItem>
                    <ListGroupItem style={{opacity: "0"}}></ListGroupItem>
                </ListGroup>
                <br></br>
                <ListGroup>
                    <ListGroupItem><h4>Getting started</h4></ListGroupItem>
                    <ListGroupItem id="works" onClick={this.onLink}>How Fractio Works</ListGroupItem>
                    <ListGroupItem id="use" onClick={this.onLink}>How to utilize Fractio</ListGroupItem>
                    <ListGroupItem style={{opacity: "0"}}></ListGroupItem>
                </ListGroup>
                <br></br>
                <ListGroup>
                    <ListGroupItem id="tokens" onClick={this.onLink}><h4 id="tokens" onClick={this.onLink}>Tokenomics</h4></ListGroupItem>
                    <ListGroupItem id="mlq"  onClick={this.onLink}>Milq Token [MLQ]</ListGroupItem>
                    <ListGroupItem id="pye"  onClick={this.onLink}>Pye Token [PYE]</ListGroupItem>
                    <ListGroupItem id="frx"  onClick={this.onLink}>Fractio Token [FRX]</ListGroupItem>
                    <ListGroupItem id="mlqp"  onClick={this.onLink}>Milquidity [MLQP]</ListGroupItem>
                    <ListGroupItem id="shk"  onClick={this.onLink}>Shake Token [SHK]</ListGroupItem>
                    <ListGroupItem style={{opacity: "0"}}></ListGroupItem>
                </ListGroup>
                <br></br>
                <ListGroup>
                    <ListGroupItem><h4>Resources</h4></ListGroupItem>
                    <ListGroupItem id="whitepaper">Whitepaper</ListGroupItem>
                    <ListGroupItem id="roadmap"  onClick={this.onLink}>Roadmap</ListGroupItem>
            ...
            <div className="col-9">
                <div><h1 id="headline">Welcome</h1>
                <p className="alert alert-info" id="content">{this.state.welcome}</p></div>
                <div className="row">
                    <Button className="col-6" style={{ marginTop: "2em",color:"lightgrey", 
                    background:"#9f95c3", fontSize: "2em", height: "2em", opacity: 0}} id="prev">Previous</Button> 
                    <Button className="col-6" style={{ marginTop: "2em",color:"lightgrey", 
                    background:"#9f95c3", fontSize: "2em", height: "2em"}} id="next">Fractio Edutainment</Button>
                </div>
            </div>
            </div>
            {/* 
