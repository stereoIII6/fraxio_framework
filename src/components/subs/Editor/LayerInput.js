            ...
            <div><h2 className="m-0 p-0">PYE Layer Editor</h2>
                <hr>
                    ...
                    <InputGroup bssize="normal" onSubmit={this.onSubmit}>
                        ...
                        <input type="file" id="file" bssize="normal" className="btn btn-info" label="x" placeholder="X" width="40px" name="file" onChange={this.onChange}/>
                        <Button className="btn btn-info" onChange={this.onChange}>
