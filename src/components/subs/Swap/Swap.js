...
class Swap extends Component {
    ...
    render() { 
        ...
        <div className="container" style={{ width: "500px", padding: "0", zIndex: "5"}}><div style={{ width: "500px"}}><p className="alert alert-info mt-1">Buy and sell Fractions of ERC721 Assets with digital currency.
Delivered on instant. </p></div></div>
