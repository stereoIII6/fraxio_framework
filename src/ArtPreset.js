...
class ArtPreset extends Component {
  ...
  bakePYE = (e) => {
    ...
    let randy = (Math.random() * 10 ** 8).toFixed();
    console.log("go mint", randy, this.state);
    const PYE = {
      id: randy,
      vrf: false,
      author: 0x0,
          ...
          keys: [
            {
              ...
              keyParams: {
                ...
                x: Number(this.state.txBG1), // x position in % (-100 - 100)
                y: Number(this.state.tyBG1), // y position in % (-100 - 100)
                z: Number(this.state.wBG1), // fixed scale (10 - 500)
                p: 0, // x/y ratio // default 0(1:1) // min -1(10:1) max 1(1:10)
                o: Number(this.state.oBG1), // opacity (0 - 100)
                r: Number(this.state.rBG1), // rotation (-360 - 360)
          ...
          keys: [
            {
              ...
              keyParams: {
                v: 0, // oracle value TRIGGER
                e: false, // external triggered by thhis key boolean
                x: Number(this.state.txBG2), // x position in % (-100 - 100)
                y: Number(this.state.tyBG2), // y position in % (-100 - 100)
                z: Number(this.state.wBG2), // fixed scale (10 - 500)
                p: 0, // x/y ratio // default 0(1:1) // min -1(10:1) max 1(1:10)
                o: Number(this.state.oBG2), // opacity (0 - 100)
                r: Number(this.state.rBG2), // rotation (-360 - 360)
                b: 0, // border thickness (1 - 5)
                c: null, // font and border color in #HEX // (#000000 - #ffffff)
                h: null, // bgcolor in #HEX // (#000000 - #ffffff)
                lc: 0, // left cut in timeline from start // video and audio only
          ...
          keys: [
            {
              ...
              keyParams: {
                v: 0, // oracle value TRIGGER
                e: false, // external triggered by thhis key boolean
                x: this.state.txOL1, // x position in % (-100 - 100)
                y: this.state.tyOL1, // y position in % (-100 - 100)
                z: this.state.wOL1, // fixed scale (10 - 500)
                p: 0, // x/y ratio // default 0(1:1) // min -1(10:1) max 1(1:10)
            ...
            },
            {
              ...
              keyParams: {
                v: 0, // oracle value TRIGGER
                e: false, // external triggered by thhis key boolean
                x: this.state.txOL2, // x position in % (-100 - 100)
                y: this.state.tyOL2, // y position in % (-100 - 100)
                z: this.state.wOL2, // fixed scale (10 - 500)
                p: 0, // x/y ratio // default 0(1:1) // min -1(10:1) max 1(1:10)
          ...
          keys: [
            {
              ...
              keyParams: {
                v: 0, // oracle value TRIGGER
                e: false, // external triggered by thhis key boolean
                x: this.state.txFG1, // x position in % (-100 - 100)
                y: this.state.tyFG1, // y position in % (-100 - 100)
                z: this.state.wFG1, // fixed scale (10 - 500)
                p: 0, // x/y ratio // default 0(1:1) // min -1(10:1) max 1(1:10)
          ...
          keys: [
            {
              ...
              keyParams: {
                v: 0, // oracle value TRIGGER
                e: false, // external triggered by thhis key boolean
                x: this.state.txFG2, // x position in % (-100 - 100)
                y: this.state.tyFG2, // y position in % (-100 - 100)
                z: this.state.wFG2, // fixed scale (10 - 500)
                p: 0, // x/y ratio // default 0(1:1) // min -1(10:1) max 1(1:10)
  ...
  onZBG1 = (e) => {
    ...
    this.setState({ wBG1: Number(e.target.value) });
  };
  onOBG1 = (e) => {
    // OBG1
    e.preventDefault();
  ...
  onZBG2 = (e) => {
    e.preventDefault();
    console.log("SCALE BG1 // ", e.target.value);
    this.setState({ wBG2: Number(e.target.value) });
  };
  onRBG2 = (e) => {
    e.preventDefault();
    console.log("ROTATE BG1 // ", e.target.value);
                  ...
                  <img
                    ...
                    style={{
                      ...
                      top: `${this.state.yFG1 +
                        (this.state.tyFG1 + this.state.tyFG1) / 2}%`,
                      left: `${this.state.xFG1 +
                        (this.state.txFG1 + this.state.txFG1) / 2}%`,
                      width: `${this.state.wFG1}%`,
                      height: "auto",
                    }}
                  />
